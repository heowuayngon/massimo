        ...
        <div class="right_content_part careers_content">
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="job_txt">
              <tr>
                <td valign="top">•</td>
                <td>&nbsp;</td>
                <td valign="top"><?php echo $lang['CAREERS_JOB_ENGINEERING_SKILL_1']; ?></td>
              </tr>
              <tr>
                <td valign="top">•</td>
                <td>&nbsp;</td>
                <td valign="top"><?php echo $lang['CAREERS_JOB_ENGINEERING_SKILL_2']; ?></td>
              </tr>
              <tr>
                <td valign="top">•</td>
                <td>&nbsp;</td>
                <td valign="top"><?php echo $lang['CAREERS_JOB_ENGINEERING_SKILL_3']; ?> </td>
              </tr>
              <tr>
                <td valign="top">•</td>
                <td>&nbsp;</td>
                <td valign="top"><?php echo $lang['CAREERS_JOB_ENGINEERING_SKILL_4']; ?></td>
              </tr>
            </table>
            <br />
            <strong><?php echo $lang['CAREERS_JOB_MINIMUM']; ?></strong><br />
            <div class="job_txt"><?php echo $lang['CAREERS_JOB_ENGINEERING_SPMV']; ?></div>
            <br />
