        ...
        <div class="right_content_part product_content">
        	<div class="float_parent">
                ...
                <div class="pro1_txt_box_1">
                	<img src="images/massimo-100-wheat-loaf.png" class="massimo-100-wheat-loaf" />
                    <p>Enjoy the quality and softness of the original Massimo Sandwich bread with added goodness and flavour of wheat with Massimo 100% Wheat Loaf - Catered to help keep you healthier and better nourished.</p>
                </div>
            </div>
        </div>
    </div>
